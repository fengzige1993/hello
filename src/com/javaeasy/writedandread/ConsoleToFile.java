...
public class ConsoleToFile {
    public static void main(String[] args){
        ...
        File datafile = prepareFile("D:\\consoleFile.txt");
        PrintWriter pw = null;
        if (datafile == null){
        ...
        String endMark = "end";
        try {
            System.out.println("请输入要写入文件的内容，以end 结束：");
    ...
    private static File prepareFile(String filePath){
        ...
        if (dataFile.exists() && dataFile.isFile()){
            ...
            try {
                ...
                System.out.println("创建的"+ filePath + "文件失败，错误信息。" + e.getMessage());
                return null;
            }
        }
